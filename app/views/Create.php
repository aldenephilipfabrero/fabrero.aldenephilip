...
<body>
  <?php if (!empty($this->session->userdata('flash_message'))): ?>
    <div style="margin-bottom:16px;padding:12px;border-radius:8px;background:#ecfeff;color:#064e3b;max-width:400px;text-align:left;">
  ...
  <input type="submit" value="Submit" aria-label="Submit create student form">
